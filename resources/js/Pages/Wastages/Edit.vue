        ...
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div class="flex justify-end space-x-4">
            ...
            >
              ...
              <span v-else>Update Wastage</span>
            </button>
          </div>
        </form>
      </div>
...
const form = useForm({
  product_id: props.wastage.product_id,
  quantity: props.wastage.quantity,
  wastage_date: props.wastage.wastage_date,
  reason: props.wastage.reason || "",
});
...
const submit = () => {
  form.put(route("wastages.update", props.wastage.id));
};
</script>
